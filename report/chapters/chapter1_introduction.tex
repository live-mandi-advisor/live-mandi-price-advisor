...
\begin{enumerate}[label=\arabic*.]
    ...
    of Indian agricultural commodity price data (Agmarknet live API, and
    the Kaggle-compiled historical Agmarknet price dataset for backfill).
...
The system's scope is finalized to three Indian states -- Tamil Nadu,
Uttar Pradesh, and Maharashtra -- and the top six most-consistently-reported
commodities per state (18 commodity-state pairs total), selected using
actual historical reporting-frequency data from the 2024--2025 backfill
rather than assumption, across roughly 15--20 mandis per state
(Table~\ref{tab:cropselection}, Chapter~3). This scope is intentionally
