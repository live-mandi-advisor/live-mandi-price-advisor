...
the \textbf{CEDA Agri Market Data} initiative (Centre for Economic Data
and Analysis, Ashoka University) compiles and republishes the same
underlying Agmarknet data with a more research-friendly export interface,
and is used in this project as the primary historical backfill source for
its academic citability.
