...
\midrule
\endhead
1 & API access, live ingestion script, state-partitioned DB schema, Kaggle parquet historical backfill for 3 finalized states & In Progress \\
2 & Data-driven top-6-crops-per-state selection (Table~\ref{tab:cropselection}, Chapter~3) & Finalized \\
