...
\midrule
\endhead
1 & API access, live ingestion script, state-partitioned DB schema, CEDA historical backfill for 2--3 states & In Progress \\
2 & Data-driven top-6-crops-per-state selection & Not Started \\
