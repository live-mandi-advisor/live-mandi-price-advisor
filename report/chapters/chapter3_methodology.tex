...
\node[box] (ceda) at (0,6) {CEDA Historical\\Backfill (one-time)};
...
one-time historical backfill from CEDA Agri Market Data before daily live
collection begins, with the larger Kaggle "Daily Market Prices of
Commodity India (2001--2026)" dataset available as a cross-check/backup
source.
...
\midrule
\endhead
Historical backfill & CEDA Agri Market Data, Kaggle (backup) & Academically citable, official-data-derived source \\
...
Both the live (Agmarknet API) and historical (CEDA) data sources have been
confirmed to be freely accessible without institutional gatekeeping,
